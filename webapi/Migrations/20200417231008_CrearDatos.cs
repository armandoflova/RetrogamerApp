        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    id_ubigeo = table.Column<int>(nullable: false),
                    nombre_ubigeo = table.Column<string>(nullable: true),
                    codigo_ubigeo = table.Column<int>(nullable: false),
                    etiqueta_ubigeo = table.Column<string>(nullable: true),
                    buscador_ubigeo = table.Column<string>(nullable: true),
                    numero_hijos_ubigeo = table.Column<int>(nullable: false),
                    nivel_ubigeo = table.Column<int>(nullable: false),
                    id_padre_ubigeo = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Ubigeos_UbigeoId",
                        column: x => x.UbigeoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    urlPrincipal = table.Column<string>(nullable: true),
                    Fecha_Registro = table.Column<DateTime>(nullable: false),
                    Estado = table.Column<bool>(nullable: false),
